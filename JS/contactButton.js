...
firstPlatform.addEventListener("click", () => {
  window.open("https://x.com/Manideep0606?t=inrqxNLxSUveIl6L350Olg&s=09");
});
secondPlatform.addEventListener("click", () => {
  window.open("mailto:manideeprkh@gmail.com");
});
thirdPlatform.addEventListener("click", () => {
  window.open("https://github.com/ManideepKumarKR");
});
fourthPlatform.addEventListener("click", () => {
  window.open("https://www.linkedin.com/in/manideep-kumar-627b1b268");
});
